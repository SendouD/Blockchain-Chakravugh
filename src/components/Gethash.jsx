...
//     setcontract_address("0xa0Ee7A142d267C1f36714E4a8F75612F20a79720")
// setIsLoading(false);
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true)
    try {
      const response = await fetch('/api/contract_address', {
        method: 'POST',
        headers: {
          ...
          >
            <div className="flex items-center border-b border-purple-500 py-2">
              ...
              <button
                ...
                disabled={isLoading}
              >
                {isLoading ? <Loader2 className="animate-spin" /> : 'Get Hash'}
              </button>
            </div>
          </motion.form>
          {contract_address && (
            ...
            >
              <h4 className="text-xl font-semibold mb-2 text-purple-300">Contract Address:</h4>
